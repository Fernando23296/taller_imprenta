      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Trabajos Iniciados</h3>
                  ...
                  <a href="?b1et=b1et&a=b1etCrud"><h4><i class="fa fa-angle-right"></i> Redactar Nueva Ejecucion de Trabajo en Corte de Papel</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->b1etListar() as $r): ?>
        <tr>
            <td><?php echo $r->idordent; ?></td>
            <td><?php echo $r->b1et_cod; ?></td>
            <td><?php echo $r->b1et_fecha; ?></td>
            <td><?php echo $r->b1et_cliente; ?></td>
            <td><?php echo $r->b1et_trab; ?></td>
            <td><?php echo $r->b1et_unid; ?></td>
            <td><?php echo $r->b1et_mate; ?></td>
            <td><?php echo $r->b1et_tama; ?></td>
            <td><?php echo $r->b1et_cant; ?></td>
            <td><?php echo $r->b1et_cortx; ?></td>
            <td><?php echo $r->b1et_otros; ?></td>
            <td><?php echo $r->b1et_obs; ?></td>
            <td><?php echo $r->b1et_pask; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?b1et=b1et&a=b1etEliminar&idb1et=<?php echo $r->idb1et; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
