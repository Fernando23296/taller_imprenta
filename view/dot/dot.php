      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Observaciones Quemado de Placas</h3>
                  ...
                  <a href="?dot=dot&a=dotCrud"><h4><i class="fa fa-angle-right"></i> Redactar Nueva Observacion de Trabajo</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->dotListar() as $r): ?>
        <tr>
            <td><?php echo $r->iddet; ?></td>
            <td><?php echo $r->dot_fecha; ?></td>
            <td><?php echo $r->dot_hora; ?></td>
            <td><?php echo $r->dot_obs; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?dot=dot&a=dotEliminar&iddot=<?php echo $r->iddot; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
