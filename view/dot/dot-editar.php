      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $dot->iddot!= null ? $iddot->Fecha: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Nuevo Registro de Observaciones</h4>
                      
                      <form id="frm-envi" action="?dot=dot&a=dotGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="iddet" value="<?php echo $dot->iddot; ?>" />
                        <!--1-->
                          ...
                          <!--2-->
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="dot_fecha" 
                                  value="<?php echo $dot->dot_fecha; ?>" 
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="dot_hora" 
                                  value="<?php echo $dot->dot_hora; ?>" 
                                  class="form-control" placeholder="<?php
...
?>">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="dot_obs" 
                                  value="<?php echo $dot->dot_obs; ?>" 
