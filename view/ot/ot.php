      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Historial de Ordenes Recibidas</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                          ...
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  <th>Fecha</th>
                                  <th>Cliente</th>
                                  <th class="numeric">Trabajo</th>
                                  <th class="numeric">Tamaño</th>
                                  <th class="numeric">Cantidad</th>
                                  <th class="numeric">Material</th>
                                  <th class="numeric">Color</th>
                                  <th class="numeric">Numeracion Inicial</th>
                                  <th class="numeric">Numeracion Final</th>
                                ...
                                <tbody>
    <?php foreach($this->model->otListar() as $r): ?>
        <tr>
            <td><?php echo $r->fecha; ?></td>
            <td><?php echo $r->cliente; ?></td>
            <td><?php echo $r->trabajo; ?></td>
            <td><?php echo $r->tamaño; ?></td>
            <td><?php echo $r->cantidad; ?></td>
            <td><?php echo $r->material; ?></td>
            <td><?php echo $r->color; ?></td>
            <td><?php echo $r->numeracion_i; ?></td>
            <td><?php echo $r->numeracion_f; ?></td>
