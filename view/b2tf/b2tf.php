      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Lista de Trabajos Finalizados</h3>
                  ...
                  <a href="?b2tf=b2tf&a=b2tfCrud"><h4><i class="fa fa-angle-right"></i> Redactar Finalizacion de Trabajo</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  ...
                                  <th class="numeric">Observacion</th> 
                                ...
                                <tbody>
    <?php foreach($this->model->b2tfListar() as $r): ?>
        <tr>
 
            <td><?php echo $r->idb2et; ?></td>
            <td><?php echo $r->b2tf_nomenc; ?></td>
            <td><?php echo $r->b2tf_fecha; ?></td>
            <td><?php echo $r->b2tf_obs; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?b2tf=b2tf&a=b2tfEliminar&idb2tf=<?php echo $r->idb2tf; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
