      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $aot->idaot!= null ? $idaot->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Nuevo Registro de Observaciones</h4>
                      
                      <form id="frm-envi" action="?aot=aot&a=aotGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="idaet" value="<?php echo $aot->idaot; ?>" />
                        <!--1-->
                          ...
                          <!--2-->
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="aot_fecha" 
                                  value="<?php echo $aot->aot_fecha; ?>" 
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="aot_hora" 
                                  value="<?php echo $aot->aot_hora; ?>" 
                                  class="form-control" placeholder="<?php
...
?>">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="aot_obs" 
                                  value="<?php echo $aot->aot_obs; ?>" 
