      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $der->idder!= null ? $idder->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Nuevo Registro de Empleado Involucrado</h4>
                      
                      <form id="frm-envi" action="?der=der&a=derGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="idder" value="<?php echo $der->idder; ?>" />
                        <!--1-->
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="der_obs" 
                                  value="<?php echo $der->der_obs; ?>" 
