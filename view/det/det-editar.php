      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $det->iddet!= null ? $iddet->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Nuevo Registro de Observaciones</h4>
                      
                      <form id="frm-envi" action="?det=det&a=detGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="idcet" value="<?php echo $det->iddet; ?>" />
                          ...
                          <!--2-->
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="idctf" 
                                  value="<?php echo $det->idctf; ?>" 
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="det_fecha" 
                                  value="<?php echo $det->det_fecha; ?>" 
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="det_nomenc" 
                                  value="<?php echo $det->det_nomenc; ?>" 
