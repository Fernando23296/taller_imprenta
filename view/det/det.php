      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Trabajos Iniciados</h3>
                  ...
                  <a href="?det=det&a=detCrud"><h4><i class="fa fa-angle-right"></i> Redactar Nueva Ejecucion de Trabajo</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              <thead>
                              <tr>
                                  <th>Nº Orden de Trabajo (Impresion)</th>
                                  <th>Fecha Inicio</th>
                                ...
                                <tbody>
    <?php foreach($this->model->detListar() as $r): ?>
        <tr>
            <td><?php echo $r->idctf; ?></td>
            <td><?php echo $r->det_fecha; ?></td>
            <td><?php echo $r->det_nomenc; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?det=det&a=detEliminar&iddet=<?php echo $r->iddet; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
