                          ...
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->craListar() as $r): ?>
        <tr>
 
            <td><?php echo $r->cra_enca; ?></td>
            <td><?php echo $r->cra_codins; ?></td>
            <td><?php echo $r->cra_desins; ?></td>
            <td><?php echo $r->cra_cant; ?></td>
            <td><?php echo $r->cra_fecha; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?cra=cra&a=craEliminar&idcra=<?php echo $r->idcra; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
