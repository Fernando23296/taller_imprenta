      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Historial Envios a Almacen</h3>
                  ...
                  <a href="?dea=dea&a=deaCrud"><h4><i class="fa fa-angle-right"></i> Redactar Envio a Almacen</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->deaListar() as $r): ?>
        <tr>
            <td><?php echo $r->iddet; ?></td>
            <td><?php echo $r->dea_nomenc; ?></td>
            <td><?php echo $r->dea_codins; ?></td>
            <td><?php echo $r->dea_desins; ?></td>
            <td><?php echo $r->dea_cant; ?></td>
            <td><?php echo $r->dea_fecha; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?dea=dea&a=deaEliminar&iddea=<?php echo $r->iddea; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
