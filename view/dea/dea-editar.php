      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $dea->iddea!= null ? $iddea->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Formulario de Envio a Almacenes</h4>
                      
                      <form id="frm-envi" action="?dea=dea&a=deaGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="iddea" value="<?php echo $dea->iddea; ?>" />
                        <!--1-->
                          ...
                          <!--2-->
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="dea_fecha" 
                                  value="<?php echo $dea->dea_fecha; ?>" 
...
?>">
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="dea_nomenc" 
                                  value="<?php echo $dea->dea_nomenc; ?>" 
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="dea_codins" 
                                  value="<?php echo $dea->dea_codins; ?>" 
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="dea_desins" 
                                  value="<?php echo $dea->dea_desins; ?>" 
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="dea_cant" 
                                  value="<?php echo $dea->dea_cant; ?>" 
