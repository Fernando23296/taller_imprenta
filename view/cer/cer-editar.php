      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $cer->idcer!= null ? $idcer->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Nuevo Registro de Empleado Involucrado</h4>
                      
                      <form id="frm-envi" action="?cer=cer&a=cerGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="idcer" value="<?php echo $cer->idcer; ?>" />
                        <!--1-->
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="cer_obs" 
                                  value="<?php echo $cer->cer_obs; ?>" 
