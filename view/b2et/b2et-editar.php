      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $b2et->idb2et!= null ? $idb2et->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Nuevo Registro de Observaciones</h4>
                      
                      <form id="frm-envi" action="?b2et=b2et&a=b2etGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="idb2et" value="<?php echo $b2et->idb2et; ?>" />
                        <!--1-->
                          ...
                          <!--2-->
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="b2et_fecha" 
                                  value="<?php echo $b2et->b2et_fecha; ?>" 
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="b2et_nomenc" 
                                  value="<?php echo $b2et->b2et_nomenc; ?>" 
