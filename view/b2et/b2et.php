      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Trabajos Iniciados</h3>
                  ...
                  <a href="?b2et=b2et&a=b2etCrud"><h4><i class="fa fa-angle-right"></i> Redactar Nueva Ejecucion de Trabajo</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->b2etListar() as $r): ?>
        <tr>
            <td><?php echo $r->iddtf; ?></td>
            <td><?php echo $r->b2et_fecha; ?></td>
            <td><?php echo $r->b2et_nomenc; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?b2et=b2et&a=b2etEliminar&idb2et=<?php echo $r->idb2et; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
