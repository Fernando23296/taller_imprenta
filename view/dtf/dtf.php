      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Lista de Trabajos Finalizados</h3>
                  ...
                  <a href="?dtf=dtf&a=dtfCrud"><h4><i class="fa fa-angle-right"></i> Redactar Finalizacion de Trabajo</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              <thead>
                              <tr>
                                  <th>Nº Orden de Trabajo</th>
                                  <th class="numeric">Nombre Participante</th>
                                  <th class="numeric">Fecha Revisado</th>
                                  <th class="numeric">Fecha Compaginado</th>
                                  <th class="numeric">Fecha Emblocado</th>
                                  <th class="numeric">Fecha Empaquetado</th>
                                  <th class="numeric">Hora de Inicio del Trabajo</th>
                                  <th class="numeric">Hora Final del Trabajo</th>
                                ...
                                <tbody>
    <?php foreach($this->model->dtfListar() as $r): ?>
        <tr>
 
            <td><?php echo $r->iddet; ?></td>
            <td><?php echo $r->dtf_nomenc; ?></td>
            <td><?php echo $r->dtf_revfech; ?></td>
            <td><?php echo $r->dtf_compfech; ?></td>
            <td><?php echo $r->dtf_embfech; ?></td>
            <td><?php echo $r->dtf_empafech; ?></td>
            <td><?php echo $r->dtf_hitrab; ?></td>
            <td><?php echo $r->dtf_hftrab; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?dtf=dtf&a=dtfEliminar&iddtf=<?php echo $r->iddtf; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
