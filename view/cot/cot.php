      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Observaciones Quemado de Placas</h3>
                  ...
                  <a href="?cot=cot&a=cotCrud"><h4><i class="fa fa-angle-right"></i> Redactar Nueva Observacion de Trabajo</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->cotListar() as $r): ?>
        <tr>
            <td><?php echo $r->idcet; ?></td>
            <td><?php echo $r->cot_fecha; ?></td>
            <td><?php echo $r->cot_hora; ?></td>
            <td><?php echo $r->cot_obs; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?cot=cot&a=cotEliminar&idcot=<?php echo $r->idcot; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
