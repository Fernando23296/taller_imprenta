                          ...
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->draListar() as $r): ?>
        <tr>
 
            <td><?php echo $r->dra_enca; ?></td>
            <td><?php echo $r->dra_codins; ?></td>
            <td><?php echo $r->dra_desins; ?></td>
            <td><?php echo $r->dra_cant; ?></td>
            <td><?php echo $r->dra_fecha; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?dra=dra&a=draEliminar&iddra=<?php echo $r->iddra; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
