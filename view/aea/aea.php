      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Historial Envios a Almacen</h3>
                  ...
                  <a href="?aea=Aea&a=aeaCrud"><h4><i class="fa fa-angle-right"></i> Redactar Envio a Almacen</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->aeaListar() as $r): ?>
        <tr>
            <td><?php echo $r->idaet; ?></td>
            <td><?php echo $r->aea_nomenc; ?></td>
            <td><?php echo $r->aea_codins; ?></td>
            <td><?php echo $r->aea_desins; ?></td>
            <td><?php echo $r->aea_cant; ?></td>
            <td><?php echo $r->aea_fecha; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?aea=aea&a=aeaEliminar&idaea=<?php echo $r->idaea; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
