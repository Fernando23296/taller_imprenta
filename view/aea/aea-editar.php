      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $aea->idaea!= null ? $idaea->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Formulario de Envio a Almacenes</h4>
                      
                      <form id="frm-envi" action="?aea=aea&a=aeaGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="idaea" value="<?php echo $aea->idaea; ?>" />
                        <!--1-->
                          ...
                          <!--2-->
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="aea_fecha" 
                                  value="<?php echo $aea->aea_fecha; ?>" 
...
?>">
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="aea_nomenc" 
                                  value="<?php echo $aea->aea_nomenc; ?>" 
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="aea_codins" 
                                  value="<?php echo $aea->aea_codins; ?>" 
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="aea_desins" 
                                  value="<?php echo $aea->aea_desins; ?>" 
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="aea_cant" 
                                  value="<?php echo $aea->aea_cant; ?>" 
