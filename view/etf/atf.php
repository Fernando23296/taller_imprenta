      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Lista de Trabajos Finalizados</h3>
                  ...
                  <a href="?atf=Atf&a=atfCrud"><h4><i class="fa fa-angle-right"></i> Redactar Finalizacion de Trabajo</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->atfListar() as $r): ?>
        <tr>
 
            <td><?php echo $r->idaet; ?></td>
            <td><?php echo $r->atf_nomenc; ?></td>
            <td><?php echo $r->atf_tipopl; ?></td>
            <td><?php echo $r->atf_tipoeq; ?></td>
            <td><?php echo $r->atf_cant; ?></td>
            <td><?php echo $r->atf_rep; ?></td>
            <td><?php echo $r->atf_mor; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?atf=atf&a=atfEliminar&idatf=<?php echo $r->idatf; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
