      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $b1tf->idb1tf!= null ? $idb1tf->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Nuevo Registro de Trabajo Finalizado</h4>
                      
                      <form id="frm-envi" action="?b1tf=b1tf&a=b1tfGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="idb1tf" value="<?php echo $b1tf->idb1tf; ?>" />
                        <!--1-->
                          ...
                          <!--2-->
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="b1tf_nomenc" 
                                  value="<?php echo $b1tf->b1tf_nomenc; ?>" 
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tipo Papel Neto</label>
                              <div class="col-sm-10">
                                  
                                  <input type="text" name="b1tf_pane" 
                                  value="<?php echo $b1tf->b1tf_pane; ?>" 
                                  class="form-control" placeholder="Ingrese Tipo de Papel Neto">
                              </div>
                          </div>
                            <!--4-->
                         <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tipo Demasía</label>
                              <div class="col-sm-10">
                                  
                                  <input type="text" name="b1tf_dem" 
                                  value="<?php echo $b1tf->b1tf_dem; ?>" 
                                  class="form-control" placeholder="Ingrese Nombre de Demasíao">
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="b1tf_tot" 
                                  value="<?php echo $b1tf->b1tf_tot; ?>" 
                                  class="form-control" placeholder="Ingrese Total">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="b1tf_otrs" 
                                  value="<?php echo $b1tf->b1tf_otrs; ?>" 
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="b1tf_obs" 
                                  value="<?php echo $b1tf->b1tf_obs; ?>" 
