      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Lista de Trabajos Finalizados</h3>
                  ...
                  <a href="?b1tf=b1tf&a=b1tfCrud"><h4><i class="fa fa-angle-right"></i> Redactar Finalizacion de Trabajo</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                  ...
                                  <th class="numeric">Tipo Placa</th>
                                  <th class="numeric">Tipo Equipo</th>
                                  <th class="numeric">Cantidad</th>
                                  <th class="numeric">Repeticiones</th>
                                  <th class="numeric">Motivo de Placas Repetidas</th>
                                ...
                                <tbody>
    <?php foreach($this->model->b1tfListar() as $r): ?>
        <tr>
 
            <td><?php echo $r->idb1et; ?></td>
            <td><?php echo $r->b1tf_nomenc; ?></td>
            <td><?php echo $r->b1tf_pane; ?></td>
            <td><?php echo $r->b1tf_dem; ?></td>
            <td><?php echo $r->b1tf_tot; ?></td>
            <td><?php echo $r->b1tf_otrs; ?></td>
            <td><?php echo $r->b1tf_obs; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?b1tf=b1tf&a=b1tfEliminar&idb1tf=<?php echo $r->idb1tf; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
