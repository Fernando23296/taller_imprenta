      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Trabajos Iniciados</h3>
                  ...
                  <a href="?cet=cet&a=cetCrud"><h4><i class="fa fa-angle-right"></i> Redactar Nueva Ejecucion de Trabajo</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              <thead>
                              <tr>
                                  <th>Nº Orden de Trabajo (Quemado de Placas)</th>
                                  <th>Nº Orden de Trabajo (Corte de Papel)</th>
                                  <th>Fecha Inicio</th>
                                ...
                                <tbody>
    <?php foreach($this->model->cetListar() as $r): ?>
        <tr>
            <td><?php echo $r->idatf; ?></td>
            <td><?php echo $r->idb1tf; ?></td>
            <td><?php echo $r->cet_fecha; ?></td>
            <td><?php echo $r->cet_nomenc; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?cet=cet&a=cetEliminar&idcet=<?php echo $r->idcet; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
