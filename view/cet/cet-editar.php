      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $cet->idcet!= null ? $idcet->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Nuevo Registro de Observaciones</h4>
                      
                      <form id="frm-envi" action="?cet=cet&a=cetGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="idcet" value="<?php echo $cet->idcet; ?>" />
                        <!--1-->
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nº Trabajo de  Quemado de Placas</label>
                              <div class="col-sm-10">
                                  
                                  <input type="text" name="idatf" 
                                  value="<?php echo $cet->idatf; ?>" 
                                  class="form-control" placeholder="Ingrese Numero de Trabajo de Quemado de Placas">
                              </div>
                          </div>
                          <!--2-->
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nº Trabajo de Corte de Papel</label>
                              <div class="col-sm-10">
                                  
                                  <input type="text" name="idb1tf" 
                                  value="<?php echo $cet->idb1tf; ?>" 
                                  class="form-control" placeholder="Ingrese Numero de Trabajo de Corte de Papel">
                              </div>
                          </div>
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="cet_fecha" 
                                  value="<?php echo $cet->cet_fecha; ?>" 
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="cet_nomenc" 
                                  value="<?php echo $cet->cet_nomenc; ?>" 
