      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Observaciones Quemado de Placas</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                      <div class="content-panel">
                  <a href="?b2ot=b2ot&a=b2otCrud"><h4><i class="fa fa-angle-right"></i> Redactar Nueva Observacion de Trabajo</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->b2otListar() as $r): ?>
        <tr>
            <td><?php echo $r->idb2et; ?></td>
            <td><?php echo $r->b2ot_fecha; ?></td>
            <td><?php echo $r->b2ot_hora; ?></td>
            <td><?php echo $r->b2ot_obs; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?b2ot=b2ot&a=b2otEliminar&idb2ot=<?php echo $r->idb2ot; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
