      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $b2ot->idb2ot!= null ? $idb2ot->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Nuevo Registro de Observaciones</h4>
                      
                      <form id="frm-envi" action="?b2ot=b2ot&a=b2otGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="idaet" value="<?php echo $b2ot->idb2ot; ?>" />
                        <!--1-->
                          ...
                          <!--2-->
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="b2ot_fecha" 
                                  value="<?php echo $b2ot->b2ot_fecha; ?>" 
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="b2ot_hora" 
                                  value="<?php echo $b2ot->b2ot_hora; ?>" 
                                  class="form-control" placeholder="<?php
...
?>">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="b2ot_obs" 
                                  value="<?php echo $b2ot->b2ot_obs; ?>" 
