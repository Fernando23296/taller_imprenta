      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Observaciones Quemado de Placas</h3>
                  ...
                  <a href="?aot=Aot&a=aotCrud"><h4><i class="fa fa-angle-right"></i> Redactar Nueva Observacion de Trabajo</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->aotListar() as $r): ?>
        <tr>
            <td><?php echo $r->idaet; ?></td>
            <td><?php echo $r->aot_fecha; ?></td>
            <td><?php echo $r->aot_hora; ?></td>
            <td><?php echo $r->aot_obs; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?aot=aot&a=aotEliminar&idaot=<?php echo $r->idaot; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
