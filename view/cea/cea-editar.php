      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $cea->idcea!= null ? $idcea->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Formulario de Envio a Almacenes</h4>
                      
                      <form id="frm-envi" action="?cea=cea&a=ceaGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="idcea" value="<?php echo $cea->idcea; ?>" />
                        <!--1-->
                          ...
                          <!--2-->
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="cea_fecha" 
                                  value="<?php echo $cea->cea_fecha; ?>" 
...
?>">
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="cea_nomenc" 
                                  value="<?php echo $cea->cea_nomenc; ?>" 
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="cea_codins" 
                                  value="<?php echo $cea->cea_codins; ?>" 
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="cea_desins" 
                                  value="<?php echo $cea->cea_desins; ?>" 
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="cea_cant" 
                                  value="<?php echo $cea->cea_cant; ?>" 
