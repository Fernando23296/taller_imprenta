      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Historial Envios a Almacen</h3>
                  ...
                  <a href="?cea=cea&a=ceaCrud"><h4><i class="fa fa-angle-right"></i> Redactar Envio a Almacen</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->ceaListar() as $r): ?>
        <tr>
            <td><?php echo $r->idcet; ?></td>
            <td><?php echo $r->cea_nomenc; ?></td>
            <td><?php echo $r->cea_codins; ?></td>
            <td><?php echo $r->cea_desins; ?></td>
            <td><?php echo $r->cea_cant; ?></td>
            <td><?php echo $r->cea_fecha; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?cea=cea&a=ceaEliminar&idcea=<?php echo $r->idcea; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
