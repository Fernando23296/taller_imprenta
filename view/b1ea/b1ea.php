      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Historial Envios a Almacen</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                      <div class="content-panel">
                  <a href="?b1ea=b1ea&a=b1eaCrud"><h4><i class="fa fa-angle-right"></i> Redactar Envio a Almacen</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->b1eaListar() as $r): ?>
        <tr>
            <td><?php echo $r->idb1et; ?></td>
            <td><?php echo $r->b1ea_nomenc; ?></td>
            <td><?php echo $r->b1ea_codins; ?></td>
            <td><?php echo $r->b1ea_desins; ?></td>
            <td><?php echo $r->b1ea_cant; ?></td>
            <td><?php echo $r->b1ea_fecha; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?b1ea=b1ea&a=b1eaEliminar&idb1ea=<?php echo $r->idb1ea; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
