      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $b1ea->idb1ea!= null ? $idb1ea->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Formulario de Envio a Almacenes</h4>
                      
                      <form id="frm-envi" action="?b1ea=b1ea&a=b1eaGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="idb1ea" value="<?php echo $b1ea->idb1ea; ?>" />
                        <!--1-->
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nº Trabajo</label>
                              <div class="col-sm-10">
                                  
                                  <input type="text" name="idb1et" 
                                  value="<?php echo $b1ea->idb1et; ?>" 
                          ...
                          <!--2-->
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="b1ea_fecha" 
                                  value="<?php echo $b1ea->b1ea_fecha; ?>" 
...
?>">
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nombre Encargado</label>
                              <div class="col-sm-10">
                                  
                                  <input type="text" name="b1ea_nomenc" 
                                  value="<?php echo $b1ea->b1ea_nomenc; ?>" 
                                  class="form-control" placeholder="Nombre de Encargado">
                              </div>
                          </div>
                            <!--4-->
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Codigo Insumo</label>
                              <div class="col-sm-10">
                                  
                                  <input type="text" name="b1ea_codins" 
                                  value="<?php echo $b1ea->b1ea_codins; ?>" 
                                  class="form-control" placeholder="Inserte Codigo de Insumo">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Descripcion Insumo</label>
                              <div class="col-sm-10">
                                  
                                  <input type="text" name="b1ea_desins" 
                                  value="<?php echo $b1ea->b1ea_desins; ?>" 
                                  class="form-control" placeholder="Inserte Descripcion de Insumo">
                              </div>
                          </div><div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Cantidad</label>
                              <div class="col-sm-10">
                                  
                                  <input type="text" name="b1ea_cant" 
                                  value="<?php echo $b1ea->b1ea_cant; ?>" 
                                  class="form-control" placeholder="Inserte Cantidad">
                              </div>
                          </div>
