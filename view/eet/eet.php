      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Trabajos Iniciados</h3>
                  ...
                  <a href="?eet=eet&a=eetCrud"><h4><i class="fa fa-angle-right"></i> Redactar Nueva Ejecucion de Trabajo</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              <thead>
                              <tr>
                                  <th>Nº Orden de Trabajo</th>
                                  <th>Nº Orden de Refilado</th>
                                  <th>Fecha Inicio</th>
                                ...
                                <tbody>
    <?php foreach($this->model->eetListar() as $r): ?>
        <tr>
            <td><?php echo $r->iddtf; ?></td>
            <td><?php echo $r->idb2tf; ?></td>
            <td><?php echo $r->eet_fecha; ?></td>
            <td><?php echo $r->eet_nomenc; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?eet=eet&a=eetEliminar&ideet=<?php echo $r->ideet; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
