      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $eet->ideet!= null ? $ideet->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Nuevo Registro de Observaciones</h4>
                      
                      <form id="frm-envi" action="?eet=eet&a=eetGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="ideet" value="<?php echo $eet->ideet; ?>" />
                        <!--1-->
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nº Trabajo</label>
                              <div class="col-sm-10">
                                  
                                  <input type="text" name="iddtf" 
                                  value="<?php echo $eet->iddtf; ?>" 
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="idb2tf" 
                                  value="<?php echo $eet->idb2tf; ?>" 
                                  class="form-control" placeholder="Ingrese Nª Refilado">
                              </div>
                          </div>
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="eet_fecha" 
                                  value="<?php echo $eet->eet_fecha; ?>" 
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="eet_nomenc" 
                                  value="<?php echo $eet->eet_nomenc; ?>" 
