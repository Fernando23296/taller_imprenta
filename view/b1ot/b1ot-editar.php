      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $b1ot->idb1ot!= null ? $idb1ot->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Nuevo Registro de Observaciones</h4>
                      
                      <form id="frm-envi" action="?b1ot=b1ot&a=b1otGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="idb1et" value="<?php echo $b1ot->idb1ot; ?>" />
                        <!--1-->
                          ...
                          <!--2-->
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="b1ot_fecha" 
                                  value="<?php echo $b1ot->b1ot_fecha; ?>" 
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="b1ot_hora" 
                                  value="<?php echo $b1ot->b1ot_hora; ?>" 
                                  class="form-control" placeholder="<?php
...
?>">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="b1ot_obs" 
                                  value="<?php echo $b1ot->b1ot_obs; ?>" 
