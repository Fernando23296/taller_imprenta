      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Observaciones Quemado de Placas</h3>
                  ...
                  <a href="?b1ot=B1ot&a=b1otCrud"><h4><i class="fa fa-angle-right"></i> Redactar Nueva Observacion de Trabajo</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->b1otListar() as $r): ?>
        <tr>
            <td><?php echo $r->idb1et; ?></td>
            <td><?php echo $r->b1ot_fecha; ?></td>
            <td><?php echo $r->b1ot_hora; ?></td>
            <td><?php echo $r->b1ot_obs; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?b1ot=b1ot&a=b1otEliminar&idb1ot=<?php echo $r->idb1ot; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
