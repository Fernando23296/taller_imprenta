      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Lista de Empleados Involucrados</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                      <div class="content-panel">
                   <a href="?b1er=b1er&a=b1erCrud"><h4><i class="fa fa-angle-right"></i> Redactar Nueva Ficha de Empleado Involucrado</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              <thead>
                              <tr>
                                  <th>Numero de Trabajo de Quemado de Placas</th>
                                  <th class="numeric">Empleado</th>
                                  <th class="numeric">Observaciones</th>
                                ...
                                <tbody>
    <?php foreach($this->model->b1erListar() as $r): ?>
        <tr>
 
            <td><?php echo $r->idb1et; ?></td>
            <td><?php echo $r->idempleado; ?></td>
            <td><?php echo $r->b1er_obs; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?b1er=b1er&a=b1erEliminar&idb1er=<?php echo $r->idb1er; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
