      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $b1er->idb1er!= null ? $idb1er->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Nuevo Registro de Empleado Involucrado</h4>
                      
                      <form id="frm-envi" action="?b1er=b1er&a=b1erGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="idb1er" value="<?php echo $b1er->idb1er; ?>" />
                        <!--1-->
                          ...
                          <!--2-->
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  value="<?php echo $b1er->idempleado; ?>" 
                                  class="form-control" placeholder="Ingrese Numero de Empleado">
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="b1er_obs" 
                                  value="<?php echo $b1er->b1er_obs; ?>" 
                                  class="form-control" placeholder="Inserte observacion">
                              </div>
                          </div>
                            <!--4-->
