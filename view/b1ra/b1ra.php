                          ...
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->b1raListar() as $r): ?>
        <tr>
 
            <td><?php echo $r->b1ra_enca; ?></td>
            <td><?php echo $r->b1ra_codis; ?></td>
            <td><?php echo $r->b1ra_desins; ?></td>
            <td><?php echo $r->b1ra_cant; ?></td>
            <td><?php echo $r->b1ra_fecha; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?b1ra=b1ra&a=b1raEliminar&idb1ra=<?php echo $b1ra->idb1ra; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
