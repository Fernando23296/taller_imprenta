          ...
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Lista de Empleados Involucrados</h3>
		  		<div class="row mt">
                   ...
                   <a href="?b2er=b2er&a=b2erCrud"><h4><i class="fa fa-angle-right"></i> Redactar Nueva Ficha de Empleado Involucrado</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->b2erListar() as $r): ?>
        <tr>
 
            <td><?php echo $r->idb2et; ?></td>
            <td><?php echo $r->idempleado; ?></td>
            <td><?php echo $r->b2er_obs; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?b2er=b2er&a=b2erEliminar&idb2er=<?php echo $r->idb2er; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
