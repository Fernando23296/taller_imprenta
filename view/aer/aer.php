          ...
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Lista de Empleados Involucrados</h3>
		  		<div class="row mt">
                   ...
                   <a href="?aer=Aer&a=aerCrud"><h4><i class="fa fa-angle-right"></i> Redactar Nueva Ficha de Empleado Involucrado</h4></a>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <tbody>
    <?php foreach($this->model->aerListar() as $r): ?>
        <tr>
 
            <td><?php echo $r->idaet; ?></td>
            <td><?php echo $r->idempleado; ?></td>
            <td><?php echo $r->aer_obs; ?></td>
         

            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?aer=aer&a=aerEliminar&idaer=<?php echo $r->idaer; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
