      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php echo $aer->idaer!= null ? $idaer->Encargado: ''; ?>
        </h1>
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Nuevo Registro de Empleado Involucrado</h4>
                      
                      <form id="frm-envi" action="?aer=aer&a=aerGuardar"  enctype="multipart/form-data"class="form-horizontal style-form" method="post">
            
                          <!--/////////////////////////////////////-->   
                          <input type="hidden" name="idaer" value="<?php echo $aer->idaer; ?>" />
                        <!--1-->
                            ...
                            <!--3-->
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <input type="text" name="aer_obs" 
                                  value="<?php echo $aer->aer_obs; ?>" 
